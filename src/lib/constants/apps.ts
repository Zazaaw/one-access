...
export const ALL_APPLICATIONS = [
    {
        ...
        launch_url: getLaunchUrl("https://iam.ptpn.id", "http://localhost:3004"),
    ...
    },
    {
        ...
        launch_url: getLaunchUrl("https://ecc.ptpn.id", "http://localhost:3007"),
        icon_name: "Activity",
    ...
    },
    {
        ...
        launch_url: getLaunchUrl("https://ihcmis.ptpn.id", "http://localhost:3001"),
        icon_name: "Users",
    ...
    },
    {
        ...
        launch_url: getLaunchUrl("https://ess.ptpn.id", "http://localhost:3006"),
        icon_name: "Briefcase",
    ...
    },
    {
        ...
        launch_url: getLaunchUrl("https://dct.ptpn.id", "http://localhost:3005"),
        icon_name: "Database",
