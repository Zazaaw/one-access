    ...
    return (
        <header className="sticky top-0 z-40 bg-[#020617]/60 backdrop-blur-2xl border-b border-slate-800/30 px-8 lg:px-12 py-5 flex items-center justify-between">
            <div className="flex-1 max-w-2xl relative group">
                ...
                <input
                    type="text"
                    placeholder="Search services, apps, or subjects..."
            ...
            <div className="flex items-center gap-6 ml-6">
                ...
                <div className="flex items-center gap-4 pl-6 border-l border-slate-800/50">
                    <div className="text-right hidden sm:block">
                        <p className="text-sm font-black text-white uppercase tracking-tight">{user?.display_name}</p>
                        <p className="text-[10px] text-emerald-500 font-bold uppercase tracking-widest">{user?.subject_type}</p>
                    </div>
                    <div className="w-11 h-11 bg-gradient-to-tr from-emerald-600 to-emerald-400 rounded-xl flex items-center justify-center text-white font-black shadow-lg shadow-emerald-900/20">
